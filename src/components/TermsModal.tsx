// Modal for terms of service shown on layout (save to local storage if user accepts)

export default function TermsModal() {
  return ( // TODO: replace it with actual modal component and make buttons work
